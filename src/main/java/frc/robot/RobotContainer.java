...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    m_operatorController.rightTrigger(OperatorConstants.kOperatorControllerTriggerThreshold).onTrue(
      new InstantCommand(
        () -> m_ShooterSystem.setShooterSpeed(ShooterConstants.kLeftShooterMotorSpeed, ShooterConstants.kRightShooterMotorSpeed)
      )
    ).onFalse(
      new InstantCommand(
        () -> m_ShooterSystem.stopShooterMotors()
      )
    );
  }
